...
/** Reads and verifies the session cookie, then loads the current Person - undefined if signed out or the token is invalid/expired. */
export async function getCurrentPerson(): Promise<Person | undefined> {
